...
// Aqui foi utilizado o index como key na função map pois se trata de uma lista estática. O index é indicado quando eu quero inserir um array de componentes que não irão ser alterados durante sua renderização.

// Como index é relacionado a posição do elemento no array, sempre que houver uma nova atualização no estado que renderiza o componente, o index é alterado e todos os outros elementos que não satisfazem a condição do estado são removidos e somente fica no array os elementos que satisfazem a condição do estado, os elementos que ficam sofrem uma mudança na sua posição do array.